...
function renderChapter(id) {
  ...
  const resetAudio = () => { audioState.index = 0; audioState.savedResumeIndex = 0; audioState.utterance = null; updateProgress(); audioTrigger.textContent = "Koute chapit la"; audioTrigger.setAttribute("aria-expanded", "false"); };
